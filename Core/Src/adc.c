...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = VBUS_ADC1_IN1_Pin|IU_ADC1_IN2_Pin;
  ...
  */
    ...
    PB11     ------> ADC2_IN14
    */
    GPIO_InitStruct.Pin = SPEED_ADC2_IN8_Pin|TEMP_ADC2_IN5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, VBUS_ADC1_IN1_Pin|IU_ADC1_IN2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB11     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOC, SPEED_ADC2_IN8_Pin|TEMP_ADC2_IN5_Pin);
